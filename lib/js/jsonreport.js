 ...
 *
 * gokulives: Tweaked to fit better with Google Chrome when used as a stand-alone utility
 *		- css moved to separate file for ease when injecting/referencing
 *		- div placed in main.html
 */
